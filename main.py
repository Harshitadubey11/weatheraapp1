...
# 22a990c5ea0106af6cbb8fceae170e07   API KEY
# api.openweathermap.org/data/2.5/weather?q={city name}&appid={API key}   API url
...
def get_weather(city):
    weather_key='22a990c5ea0106af6cbb8fceae170e07'
...
# for label
heading_title=tk.Label(bg_lbl,text='Earth including over 2,00,000 cities!',fg='red',bg='sky blue',font=('times new roman',18,'bold'))
